...
package object templating {
  ...
  case class EmailTemplateData(templateData: Map[String, TemplateData], customerProfile: Option[CustomerProfile],recipientEmailAddress: String)
  case class SMSTemplateData(templateData: Map[String, TemplateData], customerProfile: Option[CustomerProfile],recipientPhoneNumber: String)
  case class PrintTemplateData(templateData: Map[String, TemplateData], customerProfile: Option[CustomerProfile], customerAddress: CustomerAddress)
