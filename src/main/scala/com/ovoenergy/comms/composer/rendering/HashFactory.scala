...
case class EmailHashData(deliverTo: DeliverTo, templateData: Map[String, TemplateData], commManifest: CommManifest)
    extends HashData
case class SmsHashData(deliverTo: DeliverTo, templateData: Map[String, TemplateData], commManifest: CommManifest)
    extends HashData
