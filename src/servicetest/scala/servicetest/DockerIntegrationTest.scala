...
//
//  lazy val aivenZookeeper = {
//    DockerContainer("confluentinc/cp-zookeeper:3.1.1", name = Some("aivenZookeeper"))
//      .withPorts(32182 -> Some(32182))
//      .withEnv(
//        "ZOOKEEPER_CLIENT_PORT=32182",
//        "ZOOKEEPER_TICK_TIME=2000",
...
//
//    DockerContainer("wurstmeister/kafka:1.0.1", name = Some("aivenKafka"))
...
//        s"KAFKA_ADVERTISED_LISTENERS=PLAINTEXT://$hostIp:29093",
//        "KAFKA_HEAP_OPTS=-Xmx256M -Xms128M",
//        s"KAFKA_CREATE_TOPICS=$createTopicsString"
//      )
...
//        s"SCHEMA_REGISTRY_KAFKASTORE_BOOTSTRAP_SERVERS=PLAINTEXT://$hostIp:29093"
//      )
//      .withLogWritingAndReadyChecker("Server started, listening for requests", "schema-registry")
//  }
//
...
//    import scala.collection.JavaConverters._
//    val consumer = KafkaConsumer(
//      Conf[String, String](Map("bootstrap.servers" -> "localhost:29093", "group.id" -> UUID.randomUUID().toString),
//                           new StringDeserializer,
//                           new StringDeserializer))
//    consumer.assign(List(new TopicPartition(topic, 0)).asJava)
//    eventually(PatienceConfiguration.Timeout(Span(20, Seconds))) {
